...
export default function Intro() {
  ...
  const texts = [
    ...
    "Focus on Laravel, CodeIgniter, and Reactjs for building web app.",
    "Enthusiastic about continuous learning and growth.",
    "I'm currently seeking a great opportunity.",
  ];
  ...
  return (
    ...
    >
      ...
      >
        <motion.h1>Hello, I'm <span className="font-bold">Muhammad Iqbal</span></motion.h1>
        <AnimText delay={4} text={texts} />
      </motion.div>
      ...
      >
        ...
        <div className="flex gap-4">
          <a
            ...
            href="https://www.linkedin.com/in/wd-mhmd-iqbal/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
          ...
          <a
            ...
            href="https://www.github.com/mhmd-iqbal"
            target="_blank"
          >
            <FaGithubSquare />
          </a>
